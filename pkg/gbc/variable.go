...
var opcodes [256]Opcode = [256]Opcode{
	/* 0x0x */ {INS_NOP, 0, 0, 1, 1, nop}, {INS_LD, OP_BC, OP_d16, 3, 3, op0x01}, {INS_LD, OP_BC_PAREN, OP_A, 2, 2, op0x02}, {INS_INC, BC, 0, 2, 2, inc16}, {INS_INC, B, 0, 1, 1, inc8}, {INS_DEC, B, 0, 1, 1, decR8}, {INS_LD, OP_B, OP_d8, 2, 2, op0x06}, {INS_RLCA, OP_NONE, OP_NONE, 1, 1, nil}, {INS_LD, OP_a16_PAREN, OP_SP, 0, 0, op0x08}, {INS_ADD, OP_HL, OP_BC, 2, 2, nil}, {INS_LD, A, BC, 2, 2, ld8r}, {INS_DEC, OP_BC, OP_NONE, 2, 2, nil}, {INS_INC, C, 0, 1, 1, inc8}, {INS_DEC, C, 0, 1, 1, decR8}, {INS_LD, OP_C, OP_d8, 2, 2, op0x0e}, {INS_RRCA, OP_NONE, OP_NONE, 1, 1, nil},
	/* 0x1x */ {INS_STOP, 0, 0, 1, 1, stop}, {INS_LD, OP_DE, OP_d16, 3, 3, op0x11}, {INS_LD, OP_DE_PAREN, OP_A, 2, 2, op0x12}, {INS_INC, DE, 0, 2, 2, inc16}, {INS_INC, D, 0, 1, 1, inc8}, {INS_DEC, D, 0, 1, 1, decR8}, {INS_LD, OP_D, OP_d8, 2, 2, op0x16}, {INS_RLA, OP_NONE, OP_NONE, 1, 1, nil}, {INS_JR, OP_r8, OP_NONE, 0, 0, op0x18}, {INS_ADD, OP_HL, OP_DE, 2, 2, nil}, {INS_LD, A, DE, 2, 2, ld8r}, {INS_DEC, OP_DE, OP_NONE, 2, 2, nil}, {INS_INC, E, 0, 1, 1, inc8}, {INS_DEC, E, 0, 1, 1, decR8}, {INS_LD, OP_E, OP_d8, 2, 2, op0x1e}, {INS_RRA, OP_NONE, OP_NONE, 1, 1, nil},
	/* 0x2x */ {INS_JR, OP_NZ, OP_r8, 0, 0, op0x20}, {INS_LD, OP_HL, OP_d16, 3, 3, op0x21}, {INS_LD, OP_HLPLUS_PAREN, OP_A, 2, 2, op0x22}, {INS_INC, HL, 0, 2, 2, inc16}, {INS_INC, H, 0, 1, 1, inc8}, {INS_DEC, H, 0, 1, 1, decR8}, {INS_LD, OP_H, OP_d8, 2, 2, op0x26}, {INS_DAA, OP_NONE, OP_NONE, 1, 1, nil}, {INS_JR, OP_Z, OP_r8, 0, 0, op0x28}, {INS_ADD, OP_HL, OP_HL, 2, 2, nil}, {INS_LD, A, HLI, 2, 2, ld8r}, {INS_DEC, OP_HL, OP_NONE, 2, 2, nil}, {INS_INC, L, 0, 1, 1, inc8}, {INS_DEC, L, 0, 1, 1, decR8}, {INS_LD, OP_L, OP_d8, 2, 2, op0x2e}, {INS_CPL, 0, 0, 1, 1, cpl},
	/* 0x3x */ {INS_JR, OP_NC, OP_r8, 0, 0, op0x30}, {INS_LD, OP_SP, OP_d16, 3, 3, op0x31}, {INS_LD, OP_HLMINUS_PAREN, OP_A, 2, 2, op0x32}, {INS_INC, SP, 0, 2, 2, inc16}, {INS_INC, 0, 0, 0, 0, incHL}, {INS_DEC, OP_HL_PAREN, OP_NONE, 0, 0, nil}, {INS_LD, OP_HL_PAREN, OP_d8, 0, 0, op0x36}, {INS_SCF, 0, 0, 1, 1, scf}, {INS_JR, OP_C, OP_r8, 0, 0, op0x38}, {INS_ADD, OP_HL, OP_SP, 2, 2, nil}, {INS_LD, A, HLD, 2, 2, ld8r}, {INS_DEC, OP_SP, OP_NONE, 2, 2, nil}, {INS_INC, A, 0, 1, 1, inc8}, {INS_DEC, A, 0, 1, 1, decR8}, {INS_LD, OP_A, OP_d8, 2, 2, op0x3e}, {INS_CCF, 0, 0, 1, 1, ccf},

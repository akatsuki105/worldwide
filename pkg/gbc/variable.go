...
var opcodes [256]Opcode = [256]Opcode{
	...
	/* 0x3x */ {INS_JR, OP_NC, OP_r8, 0, 0, op0x30}, {INS_LD, OP_SP, OP_d16, 3, 3, op0x31}, {INS_LD, OP_HLMINUS_PAREN, OP_A, 2, 2, op0x32}, {INS_INC, OP_SP, OP_NONE, 2, 2, nil}, {INS_INC, OP_HL_PAREN, OP_NONE, 0, 0, nil}, {INS_DEC, OP_HL_PAREN, OP_NONE, 0, 0, nil}, {INS_LD, OP_HL_PAREN, OP_d8, 0, 0, op0x36}, {INS_SCF, OP_NONE, OP_NONE, 1, 1, nil}, {INS_JR, OP_C, OP_r8, 0, 0, op0x38}, {INS_ADD, OP_HL, OP_SP, 2, 2, nil}, {INS_LD, OP_A, OP_HLMINUS_PAREN, 2, 2, op0x3a}, {INS_DEC, OP_SP, OP_NONE, 2, 2, nil}, {INS_INC, A, 0, 1, 1, incR8}, {INS_DEC, A, 0, 1, 1, decR8}, {INS_LD, OP_A, OP_d8, 2, 2, op0x3e}, {INS_CCF, OP_NONE, OP_NONE, 1, 1, nil},
	...
	/* 0x7x */ {INS_LD, 0, B, 2, 2, ldHLR8}, {INS_LD, 0, C, 2, 2, ldHLR8}, {INS_LD, 0, D, 2, 2, ldHLR8}, {INS_LD, 0, E, 2, 2, ldHLR8}, {INS_LD, 0, H, 2, 2, ldHLR8}, {INS_LD, 0, L, 2, 2, ldHLR8}, {INS_HALT, OP_NONE, OP_NONE, 1, 1, nil}, {INS_LD, 0, A, 2, 2, ldHLR8}, {INS_LD, A, B, 1, 1, ldR8R8}, {INS_LD, A, C, 1, 1, ldR8R8}, {INS_LD, A, D, 1, 1, ldR8R8}, {INS_LD, A, E, 1, 1, ldR8R8}, {INS_LD, A, H, 1, 1, ldR8R8}, {INS_LD, A, L, 1, 1, ldR8R8}, {INS_LD, OP_A, OP_HL_PAREN, 2, 2, op0x7e}, {INS_LD, A, A, 1, 1, ldR8R8},

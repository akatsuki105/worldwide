...
var opcodes [256]Opcode = [256]Opcode{
	...
	/* 0xcx */ {INS_RET, flagZ, 0, 0, 0, retncc}, {INS_POP, OP_BC, OP_NONE, 3, 3, nil}, {INS_JP, flagZ, 0, 0, 0, jpncc}, {INS_JP, 0, 0, 0, 0, jp}, {INS_CALL, OP_NZ, OP_a16, 0, 0, call}, {INS_PUSH, OP_BC, OP_NONE, 4, 4, nil}, {INS_ADD, OP_A, OP_d8, 2, 2, nil}, {INS_RST, OP_00H, OP_NONE, 4, 4, nil}, {INS_RET, flagZ, 0, 0, 0, retcc}, {INS_RET, 0, 0, 4, 4, ret}, {INS_JP, flagZ, 0, 0, 0, jpcc}, {INS_PREFIX, 0, 0, 0, 0, prefixCB}, {INS_CALL, OP_Z, OP_a16, 0, 0, call}, {INS_CALL, OP_a16, OP_NONE, 0, 0, call}, {INS_ADC, OP_A, OP_d8, 2, 2, nil}, {INS_RST, OP_08H, OP_NONE, 4, 4, nil},
	/* 0xdx */ {INS_RET, flagC, 0, 0, 0, retncc}, {INS_POP, OP_DE, OP_NONE, 3, 3, nil}, {INS_JP, flagC, 0, 0, 0, jpncc}, nilOpcode, {INS_CALL, OP_NC, OP_a16, 0, 0, call}, {INS_PUSH, OP_DE, OP_NONE, 4, 4, nil}, {INS_SUB, OP_d8, OP_NONE, 2, 2, nil}, {INS_RST, OP_10H, OP_NONE, 4, 4, nil}, {INS_RET, flagC, 0, 0, 0, retcc}, {INS_RETI, 0, 0, 4, 4, reti}, {INS_JP, flagC, 0, 0, 0, jpcc}, nilOpcode, {INS_CALL, OP_C, OP_a16, 0, 0, call}, nilOpcode, {INS_SBC, OP_A, OP_d8, 2, 2, nil}, {INS_RST, OP_18H, OP_NONE, 4, 4, nil},

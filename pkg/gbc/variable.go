...
var opcodes [256]Opcode = [256]Opcode{
	...
	/* 0x4x */ {INS_LD, OP_B, OP_B, 1, 1, op0x40}, {INS_LD, OP_B, OP_C, 1, 1, op0x41}, {INS_LD, OP_B, OP_D, 1, 1, op0x42}, {INS_LD, OP_B, OP_E, 1, 1, op0x43}, {INS_LD, OP_B, OP_H, 1, 1, op0x44}, {INS_LD, OP_B, OP_L, 1, 1, op0x45}, {INS_LD, OP_B, OP_HL_PAREN, 2, 2, op0x46}, {INS_LD, OP_B, OP_A, 1, 1, op0x47}, {INS_LD, OP_C, OP_B, 1, 1, op0x48}, {INS_LD, OP_C, OP_C, 1, 1, op0x49}, {INS_LD, OP_C, OP_D, 1, 1, op0x4a}, {INS_LD, OP_C, OP_E, 1, 1, op0x4b}, {INS_LD, OP_C, OP_H, 1, 1, op0x4c}, {INS_LD, OP_C, OP_L, 1, 1, op0x4d}, {INS_LD, OP_C, OP_HL_PAREN, 2, 2, op0x4e}, {INS_LD, OP_C, OP_A, 1, 1, op0x4f},

...
var opcodes [256]Opcode = [256]Opcode{
	...
	/* 0x2x */ {INS_JR, flagZ, 0, 0, 0, jrncc}, {INS_LD, HL, 0, 3, 3, ld16i}, {INS_LD, HLI, A, 2, 2, ldm16r}, {INS_INC, HL, 0, 2, 2, inc16}, {INS_INC, H, 0, 1, 1, inc8}, {INS_DEC, H, 0, 1, 1, dec8}, {INS_LD, H, 0, 2, 2, ld8i}, {INS_DAA, OP_NONE, OP_NONE, 1, 1, nil}, {INS_JR, flagZ, 0, 0, 0, jrcc}, {INS_ADD, HL, HL, 2, 2, addHL}, {INS_LD, A, HLI, 2, 2, ld8m}, {INS_DEC, HL, 0, 2, 2, dec16}, {INS_INC, L, 0, 1, 1, inc8}, {INS_DEC, L, 0, 1, 1, dec8}, {INS_LD, L, 0, 2, 2, ld8i}, {INS_CPL, 0, 0, 1, 1, cpl},
	...
	/* 0xcx */ {INS_RET, flagZ, 0, 0, 0, retncc}, {INS_POP, OP_BC, OP_NONE, 3, 3, nil}, {INS_JP, flagZ, 0, 0, 0, jpncc}, {INS_JP, 0, 0, 0, 0, jp}, {INS_CALL, flagZ, 0, 0, 0, callncc}, {INS_PUSH, OP_BC, OP_NONE, 4, 4, nil}, {INS_ADD, OP_A, OP_d8, 2, 2, nil}, {INS_RST, OP_00H, OP_NONE, 4, 4, nil}, {INS_RET, flagZ, 0, 0, 0, retcc}, {INS_RET, 0, 0, 4, 4, ret}, {INS_JP, flagZ, 0, 0, 0, jpcc}, {INS_PREFIX, 0, 0, 0, 0, prefixCB}, {INS_CALL, flagZ, 0, 0, 0, callcc}, {INS_CALL, 0, 0, 0, 0, call}, {INS_ADC, OP_A, OP_d8, 2, 2, nil}, {INS_RST, OP_08H, OP_NONE, 4, 4, nil},
	/* 0xdx */ {INS_RET, flagC, 0, 0, 0, retncc}, {INS_POP, OP_DE, OP_NONE, 3, 3, nil}, {INS_JP, flagC, 0, 0, 0, jpncc}, nilOpcode, {INS_CALL, flagC, 0, 0, 0, callncc}, {INS_PUSH, OP_DE, OP_NONE, 4, 4, nil}, {INS_SUB, OP_d8, OP_NONE, 2, 2, nil}, {INS_RST, OP_10H, OP_NONE, 4, 4, nil}, {INS_RET, flagC, 0, 0, 0, retcc}, {INS_RETI, 0, 0, 4, 4, reti}, {INS_JP, flagC, 0, 0, 0, jpcc}, nilOpcode, {INS_CALL, flagC, 0, 0, 0, callcc}, nilOpcode, {INS_SBC, OP_A, OP_d8, 2, 2, nil}, {INS_RST, OP_18H, OP_NONE, 4, 4, nil},
	/* 0xex */ {INS_LDH, OP_a8_PAREN, OP_A, 0, 0, LDH}, {INS_POP, OP_HL, OP_NONE, 3, 3, nil}, {INS_LD, OP_C_PAREN, OP_A, 2, 2, op0xe2}, nilOpcode, nilOpcode, {INS_PUSH, OP_HL, OP_NONE, 4, 4, nil}, {INS_AND, OP_d8, OP_NONE, 2, 2, nil}, {INS_RST, OP_20H, OP_NONE, 4, 4, nil}, {INS_ADD, OP_SP, OP_r8, 4, 4, nil}, {INS_JP, 0, 0, 0, 0, jpHL}, {INS_LD, OP_a16_PAREN, OP_A, 0, 0, op0xea}, nilOpcode, nilOpcode, nilOpcode, {INS_XOR, OP_d8, OP_NONE, 2, 2, nil}, {INS_RST, OP_28H, OP_NONE, 4, 4, nil},

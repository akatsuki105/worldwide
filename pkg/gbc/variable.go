...
var opcodes [256]Opcode = [256]Opcode{
	/* 0x0x */ {INS_NOP, OP_NONE, OP_NONE, 1, 1, nil}, {INS_LD, OP_BC, OP_d16, 3, 3, op0x01}, {INS_LD, OP_BC_PAREN, OP_A, 2, 2, op0x02}, {INS_INC, OP_BC, OP_NONE, 2, 2, nil}, {INS_INC, B, 0, 1, 1, incR8}, {INS_DEC, B, 0, 1, 1, decR8}, {INS_LD, OP_B, OP_d8, 2, 2, op0x06}, {INS_RLCA, OP_NONE, OP_NONE, 1, 1, nil}, {INS_LD, OP_a16_PAREN, OP_SP, 0, 0, op0x08}, {INS_ADD, OP_HL, OP_BC, 2, 2, nil}, {INS_LD, OP_A, OP_BC_PAREN, 2, 2, op0x0a}, {INS_DEC, OP_BC, OP_NONE, 2, 2, nil}, {INS_INC, C, 0, 1, 1, incR8}, {INS_DEC, C, 0, 1, 1, decR8}, {INS_LD, OP_C, OP_d8, 2, 2, op0x0e}, {INS_RRCA, OP_NONE, OP_NONE, 1, 1, nil},
	/* 0x1x */ {INS_STOP, OP_0, OP_NONE, 1, 1, nil}, {INS_LD, OP_DE, OP_d16, 3, 3, op0x11}, {INS_LD, OP_DE_PAREN, OP_A, 2, 2, op0x12}, {INS_INC, OP_DE, OP_NONE, 2, 2, nil}, {INS_INC, D, 0, 1, 1, incR8}, {INS_DEC, D, 0, 1, 1, decR8}, {INS_LD, OP_D, OP_d8, 2, 2, op0x16}, {INS_RLA, OP_NONE, OP_NONE, 1, 1, nil}, {INS_JR, OP_r8, OP_NONE, 0, 0, op0x18}, {INS_ADD, OP_HL, OP_DE, 2, 2, nil}, {INS_LD, OP_A, OP_DE_PAREN, 2, 2, op0x1a}, {INS_DEC, OP_DE, OP_NONE, 2, 2, nil}, {INS_INC, E, 0, 1, 1, incR8}, {INS_DEC, E, 0, 1, 1, decR8}, {INS_LD, OP_E, OP_d8, 2, 2, op0x1e}, {INS_RRA, OP_NONE, OP_NONE, 1, 1, nil},
	/* 0x2x */ {INS_JR, OP_NZ, OP_r8, 0, 0, op0x20}, {INS_LD, OP_HL, OP_d16, 3, 3, op0x21}, {INS_LD, OP_HLPLUS_PAREN, OP_A, 2, 2, op0x22}, {INS_INC, OP_HL, OP_NONE, 2, 2, nil}, {INS_INC, H, 0, 1, 1, incR8}, {INS_DEC, H, 0, 1, 1, decR8}, {INS_LD, OP_H, OP_d8, 2, 2, op0x26}, {INS_DAA, OP_NONE, OP_NONE, 1, 1, nil}, {INS_JR, OP_Z, OP_r8, 0, 0, op0x28}, {INS_ADD, OP_HL, OP_HL, 2, 2, nil}, {INS_LD, OP_A, OP_HLPLUS_PAREN, 2, 2, op0x2a}, {INS_DEC, OP_HL, OP_NONE, 2, 2, nil}, {INS_INC, L, 0, 1, 1, incR8}, {INS_DEC, L, 0, 1, 1, decR8}, {INS_LD, OP_L, OP_d8, 2, 2, op0x2e}, {INS_CPL, OP_NONE, OP_NONE, 1, 1, nil},
	/* 0x3x */ {INS_JR, OP_NC, OP_r8, 0, 0, op0x30}, {INS_LD, OP_SP, OP_d16, 3, 3, op0x31}, {INS_LD, OP_HLMINUS_PAREN, OP_A, 2, 2, op0x32}, {INS_INC, OP_SP, OP_NONE, 2, 2, nil}, {INS_INC, OP_HL_PAREN, OP_NONE, 0, 0, nil}, {INS_DEC, OP_HL_PAREN, OP_NONE, 0, 0, nil}, {INS_LD, OP_HL_PAREN, OP_d8, 0, 0, op0x36}, {INS_SCF, 0, 0, 1, 1, scf}, {INS_JR, OP_C, OP_r8, 0, 0, op0x38}, {INS_ADD, OP_HL, OP_SP, 2, 2, nil}, {INS_LD, OP_A, OP_HLMINUS_PAREN, 2, 2, op0x3a}, {INS_DEC, OP_SP, OP_NONE, 2, 2, nil}, {INS_INC, A, 0, 1, 1, incR8}, {INS_DEC, A, 0, 1, 1, decR8}, {INS_LD, OP_A, OP_d8, 2, 2, op0x3e}, {INS_CCF, 0, 0, 1, 1, ccf},
	/* 0x4x */ {INS_LD, B, B, 1, 1, ldR8R8}, {INS_LD, B, C, 1, 1, ldR8R8}, {INS_LD, B, D, 1, 1, ldR8R8}, {INS_LD, B, E, 1, 1, ldR8R8}, {INS_LD, B, H, 1, 1, ldR8R8}, {INS_LD, B, L, 1, 1, ldR8R8}, {INS_LD, OP_B, OP_HL_PAREN, 2, 2, op0x46}, {INS_LD, B, A, 1, 1, ldR8R8}, {INS_LD, C, B, 1, 1, ldR8R8}, {INS_LD, C, C, 1, 1, ldR8R8}, {INS_LD, C, D, 1, 1, ldR8R8}, {INS_LD, C, E, 1, 1, ldR8R8}, {INS_LD, C, H, 1, 1, ldR8R8}, {INS_LD, C, L, 1, 1, ldR8R8}, {INS_LD, OP_C, OP_HL_PAREN, 2, 2, op0x4e}, {INS_LD, C, A, 1, 1, ldR8R8},
	/* 0x5x */ {INS_LD, D, B, 1, 1, ldR8R8}, {INS_LD, D, C, 1, 1, ldR8R8}, {INS_LD, D, D, 1, 1, ldR8R8}, {INS_LD, D, E, 1, 1, ldR8R8}, {INS_LD, D, H, 1, 1, ldR8R8}, {INS_LD, D, L, 1, 1, ldR8R8}, {INS_LD, OP_D, OP_HL_PAREN, 2, 2, op0x56}, {INS_LD, D, A, 1, 1, ldR8R8}, {INS_LD, E, B, 1, 1, ldR8R8}, {INS_LD, E, C, 1, 1, ldR8R8}, {INS_LD, E, D, 1, 1, ldR8R8}, {INS_LD, E, E, 1, 1, ldR8R8}, {INS_LD, E, H, 1, 1, ldR8R8}, {INS_LD, E, L, 1, 1, ldR8R8}, {INS_LD, OP_E, OP_HL_PAREN, 2, 2, op0x5e}, {INS_LD, E, A, 1, 1, ldR8R8},
	/* 0x6x */ {INS_LD, H, B, 1, 1, ldR8R8}, {INS_LD, H, C, 1, 1, ldR8R8}, {INS_LD, H, D, 1, 1, ldR8R8}, {INS_LD, H, E, 1, 1, ldR8R8}, {INS_LD, H, H, 1, 1, ldR8R8}, {INS_LD, H, L, 1, 1, ldR8R8}, {INS_LD, OP_H, OP_HL_PAREN, 2, 2, op0x66}, {INS_LD, H, A, 1, 1, ldR8R8}, {INS_LD, L, B, 1, 1, ldR8R8}, {INS_LD, L, C, 1, 1, ldR8R8}, {INS_LD, L, D, 1, 1, ldR8R8}, {INS_LD, L, E, 1, 1, ldR8R8}, {INS_LD, L, H, 1, 1, ldR8R8}, {INS_LD, L, L, 1, 1, ldR8R8}, {INS_LD, OP_L, OP_HL_PAREN, 2, 2, op0x6e}, {INS_LD, L, A, 1, 1, ldR8R8},
	/* 0x7x */ {INS_LD, 0, B, 2, 2, ldHLR8}, {INS_LD, 0, C, 2, 2, ldHLR8}, {INS_LD, 0, D, 2, 2, ldHLR8}, {INS_LD, 0, E, 2, 2, ldHLR8}, {INS_LD, 0, H, 2, 2, ldHLR8}, {INS_LD, 0, L, 2, 2, ldHLR8}, {INS_HALT, 0, 0, 1, 1, halt}, {INS_LD, 0, A, 2, 2, ldHLR8}, {INS_LD, A, B, 1, 1, ldR8R8}, {INS_LD, A, C, 1, 1, ldR8R8}, {INS_LD, A, D, 1, 1, ldR8R8}, {INS_LD, A, E, 1, 1, ldR8R8}, {INS_LD, A, H, 1, 1, ldR8R8}, {INS_LD, A, L, 1, 1, ldR8R8}, {INS_LD, OP_A, OP_HL_PAREN, 2, 2, op0x7e}, {INS_LD, A, A, 1, 1, ldR8R8},
	/* 0x8x */ {INS_ADD, 0, B, 1, 1, addR8}, {INS_ADD, 0, C, 1, 1, addR8}, {INS_ADD, 0, D, 1, 1, addR8}, {INS_ADD, 0, E, 1, 1, addR8}, {INS_ADD, 0, H, 1, 1, addR8}, {INS_ADD, 0, L, 1, 1, addR8}, {INS_ADD, OP_A, OP_HL_PAREN, 2, 2, nil}, {INS_ADD, 0, A, 1, 1, addR8}, {INS_ADC, 0, B, 1, 1, adcAR8}, {INS_ADC, 0, C, 1, 1, adcAR8}, {INS_ADC, 0, D, 1, 1, adcAR8}, {INS_ADC, 0, E, 1, 1, adcAR8}, {INS_ADC, 0, H, 1, 1, adcAR8}, {INS_ADC, 0, L, 1, 1, adcAR8}, {INS_ADC, OP_A, OP_HL_PAREN, 2, 2, nil}, {INS_ADC, 0, A, 1, 1, adcAR8},
	/* 0x9x */ {INS_SUB, 0, B, 1, 1, subR8}, {INS_SUB, 0, C, 1, 1, subR8}, {INS_SUB, 0, D, 1, 1, subR8}, {INS_SUB, 0, E, 1, 1, subR8}, {INS_SUB, 0, H, 1, 1, subR8}, {INS_SUB, 0, L, 1, 1, subR8}, {INS_SUB, OP_HL_PAREN, OP_NONE, 2, 2, nil}, {INS_SUB, 0, A, 1, 1, subR8}, {INS_SBC, 0, B, 1, 1, sbcAR8}, {INS_SBC, 0, C, 1, 1, sbcAR8}, {INS_SBC, 0, D, 1, 1, sbcAR8}, {INS_SBC, 0, E, 1, 1, sbcAR8}, {INS_SBC, 0, H, 1, 1, sbcAR8}, {INS_SBC, 0, L, 1, 1, sbcAR8}, {INS_SBC, OP_A, OP_HL_PAREN, 2, 2, nil}, {INS_SBC, 0, A, 1, 1, sbcAR8},
	/* 0xax */ {INS_AND, A, B, 1, 1, andR8}, {INS_AND, A, C, 1, 1, andR8}, {INS_AND, A, D, 1, 1, andR8}, {INS_AND, A, E, 1, 1, andR8}, {INS_AND, A, H, 1, 1, andR8}, {INS_AND, A, L, 1, 1, andR8}, {INS_AND, OP_HL_PAREN, OP_NONE, 2, 2, nil}, {INS_AND, A, A, 1, 1, andR8}, {INS_XOR, OP_B, OP_NONE, 1, 1, nil}, {INS_XOR, OP_C, OP_NONE, 1, 1, nil}, {INS_XOR, OP_D, OP_NONE, 1, 1, nil}, {INS_XOR, OP_E, OP_NONE, 1, 1, nil}, {INS_XOR, OP_H, OP_NONE, 1, 1, nil}, {INS_XOR, OP_L, OP_NONE, 1, 1, nil}, {INS_XOR, OP_HL_PAREN, OP_NONE, 2, 2, nil}, {INS_XOR, OP_A, OP_NONE, 1, 1, nil},
	/* 0xbx */ {INS_OR, A, B, 1, 1, orR8}, {INS_OR, A, C, 1, 1, orR8}, {INS_OR, A, D, 1, 1, orR8}, {INS_OR, A, E, 1, 1, orR8}, {INS_OR, A, H, 1, 1, orR8}, {INS_OR, A, L, 1, 1, orR8}, {INS_OR, OP_HL_PAREN, OP_NONE, 2, 2, nil}, {INS_OR, A, A, 1, 1, orR8}, {INS_CP, 0, B, 1, 1, cp}, {INS_CP, 0, C, 1, 1, cp}, {INS_CP, 0, D, 1, 1, cp}, {INS_CP, 0, E, 1, 1, cp}, {INS_CP, 0, H, 1, 1, cp}, {INS_CP, 0, L, 1, 1, cp}, {INS_CP, OP_HL_PAREN, OP_NONE, 2, 2, nil}, {INS_CP, 0, A, 1, 1, cp},
	...
	/* 0xfx */ {INS_LDH, OP_A, OP_a8_PAREN, 0, 0, LDH}, {INS_POP, OP_AF, OP_NONE, 3, 3, nil}, {INS_LD, OP_A, OP_C_PAREN, 2, 2, op0xf2}, {INS_DI, 0, 0, 1, 1, di}, nilOpcode, {INS_PUSH, OP_AF, OP_NONE, 4, 4, nil}, {INS_OR, OP_d8, OP_NONE, 2, 2, nil}, {INS_RST, OP_30H, OP_NONE, 4, 4, nil}, {INS_LD, OP_HL, OP_SP_PLUS_r8, 3, 3, op0xf8}, {INS_LD, OP_SP, OP_HL, 2, 2, op0xf9}, {INS_LD, OP_A, OP_a16_PAREN, 0, 0, op0xfa}, {INS_EI, 0, 0, 1, 1, ei}, nilOpcode, nilOpcode, {INS_CP, OP_d8, OP_NONE, 2, 2, nil}, {INS_RST, OP_38H, OP_NONE, 4, 4, nil},
}

// issue #10
// cycle0 opcode(0x36, 0xe0, 0xea, 0xf0, 0xfa) increments cycle in execution
var prefixCBs [256]Opcode = [256]Opcode{
	/* 0x0x */ {INS_RLC, B, 0, 2, 2, rlcR8}, {INS_RLC, C, 0, 2, 2, rlcR8}, {INS_RLC, D, 0, 2, 2, rlcR8}, {INS_RLC, E, 0, 2, 2, rlcR8}, {INS_RLC, H, 0, 2, 2, rlcR8}, {INS_RLC, L, 0, 2, 2, rlcR8}, {INS_RLC, 0, 0, 0, 0, rlcHL}, {INS_RLC, A, 0, 2, 2, rlcR8}, {INS_RRC, B, 0, 2, 2, rrcR8}, {INS_RRC, C, 0, 2, 2, rrcR8}, {INS_RRC, D, 0, 2, 2, rrcR8}, {INS_RRC, E, 0, 2, 2, rrcR8}, {INS_RRC, H, 0, 2, 2, rrcR8}, {INS_RRC, L, 0, 2, 2, rrcR8}, {INS_RRC, OP_HL_PAREN, OP_NONE, 0, 0, nil}, {INS_RRC, A, 0, 2, 2, rrcR8},
	...
	/* 0x2x */ {INS_SLA, B, 0, 2, 2, sla}, {INS_SLA, C, 0, 2, 2, sla}, {INS_SLA, D, 0, 2, 2, sla}, {INS_SLA, E, 0, 2, 2, sla}, {INS_SLA, H, 0, 2, 2, sla}, {INS_SLA, L, 0, 2, 2, sla}, {INS_SLA, 0, 0, 0, 0, slaHL}, {INS_SLA, A, 0, 2, 2, sla}, {INS_SRA, OP_B, OP_NONE, 2, 2, nil}, {INS_SRA, OP_C, OP_NONE, 2, 2, nil}, {INS_SRA, OP_D, OP_NONE, 2, 2, nil}, {INS_SRA, OP_E, OP_NONE, 2, 2, nil}, {INS_SRA, OP_H, OP_NONE, 2, 2, nil}, {INS_SRA, OP_L, OP_NONE, 2, 2, nil}, {INS_SRA, OP_HL_PAREN, OP_NONE, 0, 0, nil}, {INS_SRA, OP_A, OP_NONE, 2, 2, nil},
	/* 0x3x */ {INS_SWAP, 0, B, 2, 2, swap}, {INS_SWAP, 0, C, 2, 2, swap}, {INS_SWAP, 0, D, 2, 2, swap}, {INS_SWAP, 0, E, 2, 2, swap}, {INS_SWAP, 0, H, 2, 2, swap}, {INS_SWAP, 0, L, 2, 2, swap}, {INS_SWAP, 0, 0, 0, 0, swapHL}, {INS_SWAP, 0, A, 2, 2, swap}, {INS_SRL, OP_B, OP_NONE, 2, 2, nil}, {INS_SRL, OP_C, OP_NONE, 2, 2, nil}, {INS_SRL, OP_D, OP_NONE, 2, 2, nil}, {INS_SRL, OP_E, OP_NONE, 2, 2, nil}, {INS_SRL, OP_H, OP_NONE, 2, 2, nil}, {INS_SRL, OP_L, OP_NONE, 2, 2, nil}, {INS_SRL, OP_HL_PAREN, OP_NONE, 0, 0, nil}, {INS_SRL, OP_A, OP_NONE, 2, 2, nil},

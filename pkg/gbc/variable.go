...
var opcodes [256]Opcode = [256]Opcode{
	...
	/* 0x6x */ {INS_LD, H, B, 1, 1, ldR8R8}, {INS_LD, H, C, 1, 1, ldR8R8}, {INS_LD, H, D, 1, 1, ldR8R8}, {INS_LD, H, E, 1, 1, ldR8R8}, {INS_LD, H, H, 1, 1, ldR8R8}, {INS_LD, H, L, 1, 1, ldR8R8}, {INS_LD, OP_H, OP_HL_PAREN, 2, 2, op0x66}, {INS_LD, H, A, 1, 1, ldR8R8}, {INS_LD, OP_L, OP_B, 1, 1, op0x68}, {INS_LD, OP_L, OP_C, 1, 1, op0x69}, {INS_LD, OP_L, OP_D, 1, 1, op0x6a}, {INS_LD, OP_L, OP_E, 1, 1, op0x6b}, {INS_LD, OP_L, OP_H, 1, 1, op0x6c}, {INS_LD, OP_L, OP_L, 1, 1, op0x6d}, {INS_LD, OP_L, OP_HL_PAREN, 2, 2, op0x6e}, {INS_LD, OP_L, OP_A, 1, 1, op0x6f},
	/* 0x7x */ {INS_LD, OP_HL_PAREN, OP_B, 2, 2, op0x70}, {INS_LD, OP_HL_PAREN, OP_C, 2, 2, op0x71}, {INS_LD, OP_HL_PAREN, OP_D, 2, 2, op0x72}, {INS_LD, OP_HL_PAREN, OP_E, 2, 2, op0x73}, {INS_LD, OP_HL_PAREN, OP_H, 2, 2, op0x74}, {INS_LD, OP_HL_PAREN, OP_L, 2, 2, op0x75}, {INS_HALT, OP_NONE, OP_NONE, 1, 1, nil}, {INS_LD, OP_HL_PAREN, OP_A, 2, 2, op0x77}, {INS_LD, A, B, 1, 1, ldR8R8}, {INS_LD, A, C, 1, 1, ldR8R8}, {INS_LD, A, D, 1, 1, ldR8R8}, {INS_LD, A, E, 1, 1, ldR8R8}, {INS_LD, A, H, 1, 1, ldR8R8}, {INS_LD, A, L, 1, 1, ldR8R8}, {INS_LD, OP_A, OP_HL_PAREN, 2, 2, op0x7e}, {INS_LD, A, A, 1, 1, ldR8R8},
